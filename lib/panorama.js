...
Panorama.prototype.configure = function() {
    ...
    mission.client().config('control:altitude_max', altitude * 1000 + 1000);
    mission.client().config('viideo:video_channel', 0);
...
Panorama.prototype.go = function() {
    ...
    // Run the mission
    console.log("Capturing panorama at %sm altitude.", this._altitude);
